        ...
        <div className="h-screen flex overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 bg-[#f5f4f9] flex flex-col items-center justify-center p-6 overflow-y-auto">
                ...
                <div className="bg-white rounded-[18px] border border-gray-200 p-9 w-full max-w-[460px] shadow-[var(--box-shadow)]">
                    <h1 className="text-[22px] font-medium text-[#1a1135] text-center mb-1">Stwórz konto</h1>
                    <p className="text-[13px] text-gray-400 text-center mb-7">Zacznij zarządzać swoimi finansami</p>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        {/* Name */}
                        <div>
                            <label htmlFor="name" className="block text-[12.5px] text-gray-500 mb-1.5">Imię</label>
                            <input
                                type="text"
                                id="name"
                                name="name"
                        ...
                        {/* Password */}
                        <div>
                            <label htmlFor="password" className="block text-[12.5px] text-gray-500 mb-1.5">Hasło</label>
                        ...
                        {/* Confirm Password */}
                        <div>
                            <label htmlFor="confirmPassword" className="block text-[12.5px] text-gray-500 mb-1.5">Potwierdź hasło</label>
                            <div className="relative">
                                <input
                    ...
                    <p className="text-center mt-5 text-[12.5px] text-gray-400">
                        Masz już konto?{" "}
                        <Link to="/login" className="text-[#7c5bf5] hover:underline">Zaloguj się</Link>
                    </p>
                </div>
            </div>
